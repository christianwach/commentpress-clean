<?php /*
================================================================================
CommentPress Clean Theme Functions
================================================================================
...
/**
 * Set up CommentPress Clean theme.
 *
 * @since 3.0
 *
 * @return void
...
/**
 * Add CommentPress Clean WP FEE Javascript.
 *
 * @since 3.7
 *
 * @return void
 ...
 */
function commentpress_clean_body_classes( $body_classes ) {
...
add_filter( 'commentpress_body_classes', 'commentpress_clean_body_classes' );
